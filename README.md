...
The driver emulates Valve Index or HTC Vive controllers using Razer Hydra controllers. The type of controllers is switched in the settings. Changeable keyboard button press and squat are supported.
...
Button 3 | Pressing dpad down on the right controller | squat
Button 2, bumper | Grip Button | Menu button
Button 4 | Changeable keyboard button press, default `V` | Pressing dpad up on the right controller.
Start button | System button | System button
...
**Controllers spin insanely when pushed away from the base station**
